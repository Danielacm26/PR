...
public class tarea extends JFrame {
    ...
    public tarea() {
        ...
        JLabel iconLabel1 = new JLabel(new ImageIcon("media/1.jpg"));
        iconLabel1.setPreferredSize(new Dimension(90, 90));
        JLabel nameLabel1 = new JLabel("DANIELA CORREA");
        ...
        JLabel iconLabel2 = new JLabel(new ImageIcon("media/3.jpg"));
        iconLabel2.setPreferredSize(new Dimension(90, 90));
        JLabel nameLabel2 = new JLabel("FELIX MONTIEL");
        ...
        JLabel iconLabel3 = new JLabel(new ImageIcon("media/4.jpg"));
        iconLabel3.setPreferredSize(new Dimension(90, 90));
        JLabel nameLabel3 = new JLabel("REBECA FAJARDO");
        ...
        JLabel iconLabel4 = new JLabel(new ImageIcon("media/c.jpg"));
        iconLabel4.setPreferredSize(new Dimension(90, 90));
        JLabel nameLabel4 = new JLabel("MARIA DE LA CRUZ");
